...
export default function SignUp () {
  ...
  const SendRegisterRequest = async (registerData) => {
    try {
      ...
      const params = {
        method: 'POST',
        body: JSON.stringify({ username: registerData.get('firstName') + " " + registerData.get('lastName'), email: registerData.get('email'), password: registerData.get('password') }),
  ...
  return (
    <>
      {isShowInfoAlert && (<Alert onClose={handleClose} severity="info">Please fill in all fields</Alert>)}
